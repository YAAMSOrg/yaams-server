                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="msn" name="msn" value="{{ old('msn') }}" maxlength="50" placeholder="e.g. 29314">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="mtow" name="mtow" value="{{ old('mtow') }}" min="0" placeholder="e.g. 79010">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="mzfw" name="mzfw" value="{{ old('mzfw') }}" min="0" placeholder="e.g. 62730">
                                    <span class="input-group-text bg-light text-muted">kg</span>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="mlw" name="mlw" value="{{ old('mlw') }}" min="0" placeholder="e.g. 66349">
                                    <span class="input-group-text bg-light text-muted">kg</span>
                                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-0">
                            ...
                            <textarea class="form-control" id="remarks" name="remarks" rows="4" placeholder="Optional notes, paint schemes, special features, etc...">{{ old('remarks') }}</textarea>
                        </div>
                    </div>
                </div>
