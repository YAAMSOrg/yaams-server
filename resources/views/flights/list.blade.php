...
<!--
    ...
    <body>
        ...
        <div class="container" >
            <h1 class="display-1">My flights</h1>
            <p class="lead">A list of your filed flights and their status</p>

            <div class="card" style="width: 100%;">
                <div class="card-body">
                  <h5 class="card-title">XX1249</h5>
                  <h6 class="card-subtitle mb-2 text-muted">EDDK EDDS</h6>
